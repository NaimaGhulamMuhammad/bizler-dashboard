...
const AddPartner = ({visible, onClose}) => {
    ...
    return (
        ...
        >
          <Form layout="vertical" hideRequiredMark >
            <Row gutter={16}>
              <FormInput name="name" type="text" label="Name" icon={<SortDescendingOutlined />} placeholder="Enter Business Partner name" required message="Please Enter Post Title"/>
              <Col span={20}>
              <>
                <Upload
